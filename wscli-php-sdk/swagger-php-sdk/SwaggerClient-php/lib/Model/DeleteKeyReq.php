...
/**
 * DeleteKeyReq Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DeleteKeyReq implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteKeyReq';
    ...
    /**
     * Sets pgp_key_id
     * @param string $pgp_key_id 8 chars hexadecimal PGP Key Id (see e.g. gpg --list-keys)
     * @return $this
     */
