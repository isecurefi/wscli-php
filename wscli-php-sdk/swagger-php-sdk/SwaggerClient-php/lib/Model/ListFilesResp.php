...
/**
 * ListFilesResp Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ListFilesResp implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListFilesResp';
    ...
    protected static $swaggerTypes = [
        'file_descriptors' => '\Swagger\Client\Model\FileDescriptor[]',
    ...
    protected static $setters = [
        'file_descriptors' => 'setFileDescriptors',
    ...
    protected static $getters = [
        'file_descriptors' => 'getFileDescriptors',
    ...
    {
        $this->container['file_descriptors'] = isset($data['file_descriptors']) ? $data['file_descriptors'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['file_descriptors'] === null) {
            $invalid_properties[] = "'file_descriptors' can't be null";
        }
    ...
    /**
     * Gets file_descriptors
     * @return \Swagger\Client\Model\FileDescriptor[]
     */
    public function getFileDescriptors()
    {
        return $this->container['file_descriptors'];
    }

    /**
     * Sets file_descriptors
     * @param \Swagger\Client\Model\FileDescriptor[] $file_descriptors List of downloadable files from bank
     * @return $this
     */
    public function setFileDescriptors($file_descriptors)
    {
        $this->container['file_descriptors'] = $file_descriptors;
